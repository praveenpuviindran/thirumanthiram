...
The Siva and the Agochara Veeya.`,
    elaborationEnglish: `Tirumular claims in line 4 (Tamil) that he has explained in full in this text all the categories mentioned in this verse. These are the core essentials of Saiva Siddhanta philosophy. They are Sanskrit words in Tamilised form and it may be helpful to explain the terms briefly. "Jneya'' is 'that which is to be known"', "Jnana'' is "knowledge'' and ''Jnatr'' is the "knower" (subject). In Saiva Siddhanta ''Maya'' is not "'illusion'' but a kind of "purity'' (mala) which hides "Pati'', the Lord, from the vision of the imperfect ''Pasu'' (soul). It is of two kinds, "'Suddha maya'' and 'asuddha maya"'''; the evolutes from the former are five in kind, known as "'parayaya; and '"'agochara veeya'' stands for ''Siva's splendours'' here.`,
